...
//retrieved the borrow book record for the loged-in user
...
//retrieved the borrow movies record for the loged-in user
...
//retrieved the join event record for the loged-in user
